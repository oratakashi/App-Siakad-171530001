...
public class IfrJurusan extends javax.swing.JInternalFrame {
    ...
    private void showDataJurusan(){
        try{
            ...
            while(res.next()){
                vkd_jur = res.getString(1);
                vjurusan = res.getString(2);
    ...
    private void aksiSimpan(){
        ...
        try{
            ...
            clearTabelJurusan(); showDataJurusan(); clearForm(); disableInput(); aksiTambah();
        }catch(SQLException ex){
            JOptionPane.showMessageDialog(this, "Error method aksiSimpan() : "+ex);
        }
    }
    private void aksiHapus(){
        int jawab = JOptionPane.showConfirmDialog(this, "Anda yakin akan menghapus data ini? Kode : "+vkd_jur, "Konfirmasi", JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtKdJur, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(txtKdJur.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Kode jurusan belum diisi", "Informasi", JOptionPane.INFORMATION_MESSAGE);
        }else if(txtJurusan.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Anda belum mengisi jurusan", "Informasi", JOptionPane.INFORMATION_MESSAGE);
        }else{
            aksiSimpan();
        }
